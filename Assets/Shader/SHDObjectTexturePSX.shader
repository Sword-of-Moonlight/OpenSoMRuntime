...
//
Shader "OpenSoM/PSX/Object (Texture, Lit, Simple)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            V2F LitPassVertexSimple(P2V input)
            {
                ...
                // PSX: Vertex Snap
                vertexClipSpace.xy = floor(vertexClipSpace.xy * float2(320.0, 240.0)) / float2(320.0, 240.0);
        ...
        Pass
        {
            ...
            Varyings ShadowPassVertex(Attributes input)
            {
                ...
                // PSX: Vertex Snap
                output.positionCS.xy = floor(output.positionCS.xy * float2(320.0, 240.0)) / float2(320.0, 240.0);
